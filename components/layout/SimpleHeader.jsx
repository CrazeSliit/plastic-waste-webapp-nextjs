...
import { Menu, X, ShoppingCart, ChevronDown, User, LogOut, Leaf, BookOpen, Home, BarChart3, Award, MapPin, Settings, CreditCard, LayoutDashboard } from "lucide-react";
      ...
      <Container>
        <div className="flex h-18 items-center justify-between py-3">
          ...
          <nav className="hidden items-center space-x-1 md:flex">
            ...
            <NavLink href="/collection" icon={<MapPin className="h-4 w-4" />}>
              Collection
            </NavLink>
